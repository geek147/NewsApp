...
import com.envious.data.repository.PostRepositoryImpl
...
class DataModule {
    @Provides
    fun provideApiService(retrofit: Retrofit): PostApiService = PostApiService(retrofit)
    ...
    @Provides
    fun providePostRepository(repository: PostRepositoryImpl):
